...
?>
    ...
    <div class="pedidos">
        <div class="pedido-contenedor">
            <a href="estado-pedido">Modificar Estado</a> <br>
            <a href="borrar-pedido">Eliminar Pedido</a>
            <div class="listado-pedidos">
                <?php foreach($this->pedido as $ped): ?>
                    <div class="pedido">
                        <p class="pedido-item">Id pedido: <?=$ped['idpedidos']?></p>
                        ...
                        <p class="pedido-item">Email: <?=$ped['email_cliente']?></p>
